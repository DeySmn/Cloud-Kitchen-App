...
import com.restaurant.userservice.exception.HystrixTimeoutException;
...
public class UserServiceImpl implements UserService {
	...
	@Override
	@CircuitBreaker(name = "review-service", fallbackMethod = "fallbackCircuitBreaker")
	...
	public ResponseEntity<Object> fallbackCircuitBreaker(Throwable exception) throws Throwable {
		throw new HystrixTimeoutException("Timeout occured while calling review-service.");
	}
