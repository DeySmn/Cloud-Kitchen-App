...
public class ProductServiceImpl implements ProductService {
	...
	public CustomResponseEntity<Object> getAllProduct() {
		...
		return new CustomResponseEntity<Object>(allProducts, HttpStatus.OK);
	}
	...
	public CustomResponseEntity<Object> getProductById(long pId) throws ProductNotFoundException {
		...
		return new CustomResponseEntity<Object>(product, HttpStatus.OK);
	}
	...
	public CustomResponseEntity<Object> getProductByFoodType(String type) throws FoodTypeNotExistsException {
		...
		try {
			...
			return new CustomResponseEntity<Object>(list, HttpStatus.OK);
		} catch (Exception e) {
	...
	public CustomResponseEntity<Object> addProduct(Product product) {
		...
		return new CustomResponseEntity<Object>(response, HttpStatus.OK);
	}

	@Override
	public CustomResponseEntity<Object> updateProduct(Product newProduct) throws ProductNotFoundException {
