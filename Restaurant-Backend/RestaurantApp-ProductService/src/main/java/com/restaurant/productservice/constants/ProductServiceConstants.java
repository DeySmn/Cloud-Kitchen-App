...
public class ProductServiceConstants {
	...
	public static final String RETRIEVEREVIEWBYPID_URI = "/api/v1/productservice/user/{pId}/review";
	...
	public static final String UPDATEUSERIMAGES_URI = "/api/v1/productservice/user/update/image";
}
